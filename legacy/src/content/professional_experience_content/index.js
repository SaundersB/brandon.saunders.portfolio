...
let experience = [
    {
        [COMPANY_NAME]: "JNR Incorporated",
        [WORK_TYPE_NAME]: "Full Time",
        [START_DATE_NAME]: "07-2018",
    ...
    {
        [COMPANY_NAME]: "Vantage LED",
        [WORK_TYPE_NAME]: "Full Time",
        [START_DATE_NAME]: "06-2016",
        [END_DATE_NAME]: "07-2018",
        [EXPERIENCE_NAME]: "Develop software for digital signage, internal business tools, and work to develop digital signage solutions in the Electronic Shelving Label and scoreboard markets.\n" +
            "Accomplishments:\n" +
    ...
    {
        [COMPANY_NAME]: "Tribogenics",
        [WORK_TYPE_NAME]: "Full Time (Summer), Part Time (School in Session)",
        [START_DATE_NAME]: "07-2015",
        [END_DATE_NAME]: "06-2016",
        [EXPERIENCE_NAME]: "Development and support of the Watson X-Ray Fluorescence gun through the delivery of new Android software features and internal support software solutions.\n" +
    ...
    {
        [COMPANY_NAME]: "Bumblebee Wireless",
        [WORK_TYPE_NAME]: "Full Time (Summer), Part Time (School in Session)",
        [START_DATE_NAME]: "08-2013",
        [END_DATE_NAME]: "07-2015",
        [EXPERIENCE_NAME]: "Repaired Apple, Samsung, LG, HTC, and several other popular celluar brands. \n" +
