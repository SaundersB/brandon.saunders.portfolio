        ...
        <Layout>
            ...
            <StaticQuery
                ...
                render={(data) => {
                    ...
                    return (
                        <div className={'d-flex white-background'}>
                            <div className={'container col d-flex justify-content-center align-content-center'}>
                                <div className={'row pb-4 inner-content-wrapper content-card white-background mt-lg-4'}>
                                    <div className={'col'}>
                                        ...
                                        <div className={'row p-2'}>
                                            <div className={'col'}>
                                                ...
                                                <div className={'default-text'}>Full stack software engineer with 5
                                                    years of
                                                    experience building
                                                    ...
                                                    return (
                                                        <div className='col pl-0'>
                                                            <div className={'col pb-4 flex-wrap'}
                                                                ...
                                                                <div className={'row pt-2'}>
                                                                    <div className={'header-two'}>Technologies Used
                                                                    </div>
                                                                </div>
                                        ...
                                        <div className={'row p-2'}>
                                            <div className={'col pb-4 flex-wrap'}>
                                                ...
                                                <div className={'row justify-content-between p-auto m-auto'}>
                                                    <div className={'header-two bold-text'}>Bachelor of Science,
                                                        Computer
                                                        Science - 2016
                                                    </div>
