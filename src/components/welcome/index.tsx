    ...
    return (
        <div
            className={'d-flex row gradient container'}>
                <div className="d-flex col-xs-12 col-md-5 justify-content-md-end justify-content-center
                                align-items-md-center align-items-end p-md-2 p-xs-0">
                    <div className="d-flex justify-content-end p-0">
                        <ProfilePhoto/>
                    </div>
                </div>
                <div
                    className="d-flex col-xs-12 col-lg-7 col-md-7 p-0 p-md-1 p-sm-0 m-auto ml-md-0 mb-auto mt-auto
